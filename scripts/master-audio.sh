...
for slug in "${TARGETS[@]}"; do
  ...
  ffmpeg -y -i "$IN" -stream_loop -1 -i "$AMBIENT" -filter_complex "
    [0:a]highpass=f=85,afftdn=nr=10:nf=-45,acompressor=threshold=-20dB:ratio=2.5:attack=8:release=180,equalizer=f=3500:t=q:w=2.5:g=-2.5,equalizer=f=6500:t=q:w=2.5:g=1.2,equalizer=f=11500:t=h:width=4000:g=2,loudnorm=I=-16:LRA=7:TP=-1.5[voice];
    [1:a]volume=-26dB,afade=t=in:d=0.6[bed];
