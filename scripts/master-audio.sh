...
for slug in "${TARGETS[@]}"; do
  ...
  ffmpeg -y -i "$IN" -stream_loop -1 -i "$AMBIENT" -filter_complex "
    [0:a]highpass=f=85,adeclick=window=55:overlap=75:arorder=2:threshold=2:burst=2,afftdn=nr=14:nf=-50,acompressor=threshold=-20dB:ratio=2.5:attack=8:release=180,equalizer=f=3500:t=q:w=2:g=-2,equalizer=f=8000:t=q:w=2:g=1.5,aexciter=amount=1.5:drive=3:freq=8000:ceil=12000,equalizer=f=13000:t=h:width=4000:g=2.5,loudnorm=I=-16:LRA=3:TP=-1.5[voice];
    [1:a]volume=-19.5dB,afade=t=in:d=0.6[bed];
